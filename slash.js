...
const commands = [
	...
	new SlashCommandBuilder()
		...
		.addSubcommand((subcommand) =>
			subcommand
				...
				.setDescription("Play Radio")
				.addStringOption((option) =>
					option.setName("query").setDescription("Radio Query").setRequired(true).setAutocomplete(true)
				)
		)
	...
	new SlashCommandBuilder()
		...
		.addIntegerOption((option) =>
			option.setName("position").setDescription("Target position 1 ~ queue size").setRequired(true)
		),
